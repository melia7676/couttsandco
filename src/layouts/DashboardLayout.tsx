...
// Helper to get initials from full name or email
...
export function DashboardLayout() {
  ...
  const firstName = getFirstName(profile?.full_name) || user.email?.split("@")[0] || "Client";
  const initials = getInitials(profile?.full_name, user.email);
  const memberTier = "Premium"; // You can add a 'tier' column to Supabase profiles later
          ...
          <div className="p-4 border-t border-border">
            <div className="flex items-center gap-3 p-3 rounded-xl bg-secondary/50">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground">{memberTier} Member</p>
              </div>
              <Button 
                variant="ghost" 
                size="icon" 
